...
class TestVocab(TorchtextTestCase):
    ...
    def test_download_charngram_vectors(self):
        ...
        for _ in range(2):
            ...
            expected_charngram = {
                ...
                'world': [-0.29590717, -0.05275926, -0.37334684,
                          0.27117205, -0.3868292],
            }
            ...
            expected_oov_token_charngram = [-0.1070, -0.2240, -0.3043,
                                            -0.1092, 0.0953]
            self.assertEqual(vectors['OOV token'][0, :5],
                             expected_oov_token_charngram, atol=0, rtol=10e-4)
    ...
    def test_download_custom_vectors(self):
        ...
        for _ in range(2):
            ...
            for word in expected_fasttext_simple_en:
                self.assertEqual(
                    vectors[word][:5], expected_fasttext_simple_en[word])
    ...
    def test_download_glove_vectors(self):
        ...
        for word in expected_twitter:
            self.assertEqual(
                vectors[word][:5], expected_twitter[word])
