...
class TestVectors(TorchtextTestCase):
    ...
    def test_factory_methods(self):
        ...
        with tempfile.TemporaryDirectory() as dir_name:
            ...
            # GloVeOld(name='840B', dim=300, cache=dir_name)
            # GloVe(name='840B', dim=300, root=dir_name, validate_file=False)

            # GloVeOld(name='twitter.27B', dim=25)


            # GloVe(name='twitter.27B', dim=25)
            # GloVe(name='twitter.27B', dim=50)
            # GloVe(name='twitter.27B', dim=100)
