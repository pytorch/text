...
class TestTransforms(TorchtextTestCase):
    ...
    def _t5tokenizer_test(self, transform):
    ...
    def test_t5tokenizer(self) -> None:
        ...
        self._t5tokenizer_test(transform=self._t5tokenizer(test_scripting=False))
    ...
    def test_t5tokenizer_jit(self) -> None:
        ...
        self._t5tokenizer_test(transform=self._t5tokenizer(test_scripting=True))

    def test_t5tokenizer_pickle(self) -> None:
        """test tokenization on string input (encode) and translation from token ids to strings (decode) with pickling"""
        transform = self._t5tokenizer(test_scripting=False)
        transform_pickled = pickle.loads(pickle.dumps(transform))
        self._t5tokenizer_test(transform=transform_pickled)
