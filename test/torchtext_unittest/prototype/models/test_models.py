...
class TestModels(TorchtextTestCase):
    ...
    def test_t5_bundler_load_hf_ckpt_pretrained_encoder_only(self) -> None:
        t5_small_enc_path = get_asset_path("hf_t5_small_enc")
        our_encoder = T5Bundle.build_model_from_huggingface_ckpt(t5_small_enc_path)
        hf_encoder = T5EncoderModel.from_pretrained(t5_small_enc_path)
    ...
    def test_t5_bundler_load_hf_ckpt_pretrained_encoder_decoder(self) -> None:
        ...
        t5_small_path = get_asset_path("hf_t5_small")
        our_t5 = T5Bundle.build_model_from_huggingface_ckpt(t5_small_path)
        hf_t5 = T5Model.from_pretrained(t5_small_path)
        ...
        test_model(our_output, hf_output, our_t5.config, encoder_only=False)
    ...
    def test_t5_bundler_load_hf_ckpt_pretrained_encoder_decoder_with_gen(self) -> None:
        ...
        t5_small_path_gen = get_asset_path("hf_t5_small_gen")
        our_t5 = T5Bundle.build_model_from_huggingface_ckpt(t5_small_path_gen)
        hf_t5 = T5ForConditionalGeneration.from_pretrained(t5_small_path_gen)
