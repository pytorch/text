...
T5_SMALL_ENCODER.__doc__ = """
    T5_BASE_ENCODER is an encoder-only model from a pre-trained T5 model with the small configuration..
    It returns the normalized output from the final layer of the encoder.
...
T5_SMALL.__doc__ = """
    T5_BASE is an encoder-decoder model from a pre-trained T5 model with the small configuration.
    It returns the normalized output from the final layer of the decoder.
...
T5_SMALL_GENERATION.__doc__ = """
    T5_BASE_GENERATION is an encoder-decoder model from a pre-trained T5 model with the small configuration.
    It returns the output of the final layer of the decoder after passing through a linear layer to project the hidden states to
    the model vocabulary. This output can then be used for language generation.
...
T5_LARGE_ENCODER.__doc__ = """
    T5_BASE_ENCODER is an encoder-only model from a pre-trained T5 model with the large configuration..
    It returns the normalized output from the final layer of the encoder.
...
T5_LARGE.__doc__ = """
    T5_BASE is an encoder-decoder model from a pre-trained T5 model with the large configuration.
    It returns the normalized output from the final layer of the decoder.
...
T5_LARGE_GENERATION.__doc__ = """
    T5_BASE_GENERATION is an encoder-decoder model from a pre-trained T5 model with the large configuration.
    It returns the output of the final layer of the decoder after passing through a linear layer to project the hidden states to
    the model vocabulary. This output can then be used for language generation.
