...
def MismatchedMultiNLI(root='.data', split=('train', 'dev'), offset=0):
    ...
    for item in split:
        if item == 'train':
            ...
            path = find_match('dev_mismatched.jsonl', extracted_files)
        datasets.append(RawTextIterableDataset("MismatchedMultiNLI", NUM_LINES[item],
